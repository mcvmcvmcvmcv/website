...
<img width="{{ page.image_container }}" src="{{ page.image_path | resize: page.image_resize }}" alt="Ikebana at Hikone Station in the daytime" />

Eventually, I came to photograph it in the morning when I arrived, and in the evening on my way home.

<img width="{{ page.image_container }}" src="{{ page.img2 | resize: page.image_resize }}" alt="Ikebana at Hikone Station at night" />
